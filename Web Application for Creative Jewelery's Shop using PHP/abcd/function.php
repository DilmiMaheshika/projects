...
function get_pro_cats(){
	...
	while($row_p_cats=mysqli_fetch_array($run_pro_cats)){
		...
		<li class='nav_item' style='padding:0 10px '>
		
		<a class='btn btn-gold' style='color: #b69d00;background-color: #ffffff;border-color: #cb8e35;font-size:20px' href='home.php?product_cat=$pro_cat_id'> $pro_cat_name </a>
...
function get_pro_cat_pro(){
	...
	while($row_cats=mysqli_fetch_array($run_cats)){
		...
		<a class='btn btn-gold' style='color: #b69d00;background-color: #ffffff;border-color: #cb8e35;font-size:20px' href='home.php?cat=$cat_id'> $cat_name </a>
